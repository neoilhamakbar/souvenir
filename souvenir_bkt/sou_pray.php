<?php
require '../connect.php';
$fasilitas_tempat_sholat = $_GET['fasilitas_tempat_sholat'];
$querysearch    ="SELECT 
souvenir.id,
souvenir.name,
souvenir.address,
...
WHERE
souvenir.fasilitas_tempat_sholat = '$fasilitas_tempat_sholat'"; 
$data = array();
...
WHERE
small_industry.fasilitas_tempat_sholat = '$fasilitas_tempat_sholat'"; 
