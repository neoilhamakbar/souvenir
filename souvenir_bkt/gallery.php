              ...
              { 
               ...
               var fasilitas_tempat_sholat=row.fasilitas_tempat_sholat;
                ...
                map.setZoom(18); 
                    ...
                    if(i==0){
                      $('#detgal').append("<tr><td>Name</td><td>:</td><td> "+name+"</td></tr><br><tr><td>Address</td><td>:</td><td> "+address+"</td></tr><br><tr><td>Telephone</td><td>:</td><td> "+cp+"</td></tr><br><tr><td>Rating</td><td>:</td><td> "+rating+"</td></tr><br><tr><td>Parking Facilities</td><td>:</td><td> "+fasilitas_parkir+"</td></tr><br><tr><td>Prayer Facilities</td><td>:</td><td> "+fasilitas_tempat_sholat+"</td></tr><br><tr><td>Owner</td><td>:</td><td> "+owner+"</td></tr><br><tr><td>Place's Status</td><td>:</td><td> "+status+"</td></tr><br><tr><td>Type</td><td>:</td><td> "+type+"</td></tr><tr><td><b> Product </b></td><td></td><td><b> Price </b></td></tr>");
                    }
